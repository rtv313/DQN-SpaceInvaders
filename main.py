...
policy_net = DeepQNetwork(input_shape=(environment_manager.get_input_shape(),), action_space = environment_manager.num_actions_available(),batch_size = batch_size)
target_net = DeepQNetwork(input_shape=(environment_manager.get_input_shape(),), action_space = environment_manager.num_actions_available(),batch_size = batch_size)
...
for episode in range(num_episodes):
    ...
    while not environment_manager.done:
        ...
        max_episode_reward = reward if (reward > max_episode_reward) else max_episode_reward
        state = next_state
